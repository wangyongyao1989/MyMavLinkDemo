...
static inline uint16_t mavlink_msg_get_send_buffer_length(const mavlink_message_t *msg) {
    ...
    uint16_t signature_len = (msg->incompat_flags & MAVLINK_IFLAG_SIGNED)
 ...
 */
static inline void
_mav_put_char_array(char *buf, uint8_t wire_offset, const char *b, uint8_t array_length) {
 ...
 */
static inline void
_mav_put_uint8_t_array(char *buf, uint8_t wire_offset, const uint8_t *b, uint8_t array_length) {
    mav_array_memcpy(&buf[wire_offset], b, array_length);
 ...
 */
static inline void
_mav_put_int8_t_array(char *buf, uint8_t wire_offset, const int8_t *b, uint8_t array_length) {
    mav_array_memcpy(&buf[wire_offset], b, array_length);
